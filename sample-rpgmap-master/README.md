...
First, [run the sample](defold://project.build) and walk through the 3x3 screen big world to get a feel for the sample's setup. You control the character with the arrow keys.
